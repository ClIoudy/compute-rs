...
pub async fn execute_kernel(shader_binary: wgpu::ShaderModuleDescriptor<'static>, input: Vec<u32>) -> () {
...
fn main() {
    ...
    futures::executor::block_on(execute_kernel(shader_binary, (0..128).collect()));
